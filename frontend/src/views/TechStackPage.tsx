...
const TechStackPage: React.FC = () => {
    ...
    /* useHover is better, this is for example only. Separating into new component is viable too */
    ...
    return (
        <div className="container mx-auto">
            <section className="my-6">
                <h1 className="py-6 text-6xl font-bold text-center text-transparent bg-gradient-to-r from-purple-400 to-pink-300 dark:bg-gradient-to-r dark:from-yellow-500 dark:to-yellow-300 dark:bg-clip-text dark:text-transparent bg-clip-text">
                    TECH IN THIS PROJECT
                </h1>
                <p className="mb-12 text-center">hover cards for example components (use redux example)</p>
            </section>
            <div className="container mx-auto">
                <div className="grid grid-cols-4 gap-4">
                    <div className="p-4 border rounded-md border-slate-400 bg-slate-300 dark:border-slate-700 dark:bg-slate-800">
                        <h2 className="pb-4 text-4xl font-bold">Vite</h2>
                    ...
                    <div className="p-4 border rounded-md border-slate-400 bg-slate-300 dark:border-slate-700 dark:bg-slate-800">
                        <h2 className="pb-4 text-4xl font-bold">React</h2>
                    ...
                    <div id="redux" className="p-4 border rounded-md border-slate-400 bg-slate-300 dark:border-slate-700 dark:bg-slate-800" onMouseEnter={() => handleHover(true)} onMouseLeave={() => handleHover(false)}>
                        {hovered ?
                        <Counter /> :
                        <div>
                            <h2 className="pb-4 text-4xl font-bold">Redux</h2>
                    ...
                    <div className="p-4 border rounded-md border-slate-400 bg-slate-300 dark:border-slate-700 dark:bg-slate-800">
                        <h2 className="pb-4 text-4xl font-bold">TailwindCSS</h2>
                    ...
                    <div className="p-4 border rounded-md border-slate-400 bg-slate-300 dark:border-slate-700 dark:bg-slate-800">
                        <h2 className="pb-4 text-4xl font-bold">Typescript</h2>
                    ...
                    <div className="p-4 border rounded-md border-slate-400 bg-slate-300 dark:border-slate-700 dark:bg-slate-800">
                        <h2 className="pb-4 text-4xl font-bold">Jest</h2>
                    ...
                    <div className="p-4 border rounded-md border-slate-400 bg-slate-300 dark:border-slate-700 dark:bg-slate-800">
                        <h2 className="pb-4 text-4xl font-bold">Vercel</h2>
                    ...
                    <div className="p-4 border rounded-md border-slate-400 bg-slate-300 dark:border-slate-700 dark:bg-slate-800">
                        <h2 className="pb-4 text-4xl font-bold">CI / CD</h2>
